  ...
  return (
    <div>
      ...
      <Modal
        ...
        title={editing ? '✏️ Ekip Düzenle' : '✨ Yeni Ekip'}
      >
        <form onSubmit={saveForm}>
          {/* Ekip Adı */}
          <div className="form-group">
            <label className="form-label">
              👥 Ekip Adı <span style={{ color: 'var(--color-danger)' }}>*</span>
            </label>
            <input
              type="text"
      ...
      <Modal
        ...
        title={selectedTeam ? `👥 ${selectedTeam.ad} - Üyeler` : '👥 Ekip Üyeleri'}
      >
        {/* Yeni Üye Ekle */}
        <div className="form-group" style={{ marginBottom: 24 }}>
          <label className="form-label">➕ Yeni Üye Ekle</label>
